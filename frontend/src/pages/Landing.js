          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-3 mb-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl hover:opacity-90 transition disabled:opacity-50 font-medium"
              >
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 p-3 border-2 border-gray-300 rounded-xl hover:border-gray-400 transition disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 p-3 bg-black text-white rounded-xl hover:bg-gray-800 transition disabled:opacity-50"
              >
